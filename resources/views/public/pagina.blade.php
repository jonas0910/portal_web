...
<style>
    .card-regidor { border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); transition: box-shadow 0.3s, transform 0.2s; }
    .card-regidor:hover { box-shadow: 0 4px 16px rgba(0,0,0,0.1); transform: translateY(-2px); }
    .avatar-regidor { width: 90px; height: 90px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 1rem; }
    .badge-partido { border-radius: 50px; padding: 0.35em 0.85em; font-weight: 500; }
</style>
@endif
<style>
    .page-header {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    ...
                    @elseif(isset($miembros) && $miembros->count() > 0)
                        {{-- Miembros Dinámicos (Junta, Tribunal, etc) --}}
                        @include('public.partials.miembros-seccion')
                    @else
                    {{-- Contenido Principal --}}
                    @if($pagina->contenido)
                        <div class="content">
                    ...
                    {{-- Contenido EspecÃƒÂ­fico por Tipo --}}
                                                ...
                                                <div class="card h-100 shadow-sm">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <span class="text-primary fw-bold">S/. {{ is_numeric($servicio->precio_base) ? number_format($servicio->precio_base, 2) : '0.00' }}</span>
